...
import { View, Text, TouchableOpacity, FlatList, Image, ActivityIndicator, Alert, Dimensions, SectionList } from 'react-native';
...
type BookcaseScreenProps = NativeStackScreenProps<
BookcaseStackParamList,
'Bookcase'
>;
const BookcaseScreen=({navigation}: BookcaseScreenProps) => {
